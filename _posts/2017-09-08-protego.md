...
![alt protego_overview]({{ site.url }}/images/protego_overview.png)

![alt protego_module_interaction]({{ site.url }}/images/protego_module_interaction.png)
...
![alt protego_operational_message_traffic]({{ site.url }}/images/protego_operational_message_traffic.png)
...
![alt protego_programming_box_traffic]({{ site.url }}/images/protego_programming_box_traffic.png)
...
![alt protego_spi_registers]({{ site.url }}/images/protego_spi_registers.png)
...
![alt protego_erase_event]({{ site.url }}/images/protego_erase_event.png)
![alt protego_missile_missing]({{ site.url }}/images/protego_missile_missing.png)
...
![alt protego_microcontroller_memory]({{ site.url }}/images/protego_microcontroller_memory.png)
...
![alt protego_suitcase_leds]({{ site.url }}/images/protego_suitcase_leds.png)
